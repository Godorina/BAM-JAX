...
export JAX_PROCESS_INDEX=1    # Node 2 = index 1
...
########################################
echo "=========================================="
echo "JAX Unified Sharded Training - Node 2 (Worker)"
...
if [ -f training_node2.log ]; then
    mv training_node2.log training_node2.log.${TIMESTAMP}.bak
fi

echo "Starting training at $(date)"

python -m bam.training.train_unified $CONFIG 2>&1 | tee -a training_node2.log
